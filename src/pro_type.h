...
PRO_INTERNAL void initialize_default_actor_types(pro_state*);

PRO_INTERNAL pro_actor_type_info_list* pro_actor_type_info_list_new(pro_state*, 
    pro_actor_type type, pro_actor_type_info* value, pro_actor_type_info_list* next);

PRO_INTERNAL const pro_actor_type_info* pro_get_actor_type_info(pro_state*, 
    pro_actor_type type);

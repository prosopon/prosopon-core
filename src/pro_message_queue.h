 ...
 */
PRO_INTERNAL
pro_message_queue* pro_message_queue_new(pro_state_ref);

/**
 * Releases the memory for a message queue.
 */
PRO_INTERNAL
void pro_message_queue_free(pro_state_ref, pro_message_queue*);

/**
 * Places a message in the message queue.
 */
PRO_INTERNAL
void pro_message_queue_enqueue(pro_state_ref, pro_message_queue*,
 ...
 */
PRO_INTERNAL
pro_ref pro_message_queue_dequeue(pro_state_ref,
 ...
 */
PRO_INTERNAL
int pro_message_queue_is_empty(pro_state_ref,
    pro_message_queue*);

 ...
 */
PRO_INTERNAL
pro_binding_map* pro_binding_map_copy(pro_state_ref s, pro_binding_map*);

/**
 * Releases a binding map.
 */
PRO_INTERNAL
void pro_binding_map_free(pro_state_ref s, pro_binding_map*);
 ...
 */
PRO_INTERNAL
pro_ref pro_binding_map_get(pro_state_ref s, pro_binding_map*,
    const char*);
 ...
 */
PRO_INTERNAL
void pro_binding_map_put(pro_state_ref s, pro_binding_map*, 
    const char*, pro_ref);
